...
import MainMenuOnePage7 from "../MainMenuOnePage7";

export default function Header({ scroll, isMobileMenu, handleMobileMenu, mainMenuStyle }: any) {
    return (
        <>
            <header>
                <div className={`header-area header-area7 header-area-all d-none d-lg-block ${scroll ? "sticky" : ""} `} id="header">
                            ...
                            <div className="col-12">
                                <div className="header-elements">
                                    <div className="site-logo">
                                        <Link href="/">
                                            <img src="assets/img/logo/header-logo7.png" alt="" />
                                        </Link>
                                    </div>
                                    <div className="main-menu-ex main-menu-ex1">
                                        {!mainMenuStyle && <MainMenu />}
                                        {mainMenuStyle == "one-page" ? <MainMenuOnePage7 /> : null}
                                    </div>
                                    <div className="header2-buttons">
                                        <div className="button">
                                            <Link className="theme-btn12" href="/contact">
                                                Contact Us
                                            </Link>
                                        </div>
                                    </div>
