...
import MainMenuOnePage5 from "../MainMenuOnePage5";

export default function Header({ scroll, isMobileMenu, handleMobileMenu, mainMenuStyle }: any) {
    return (
        <>
            <header>
                <div className={`header-area header-area2 header-area-all d-none d-lg-block ${scroll ? "sticky" : ""} `} id="header">
                            ...
                            <div className="col-12">
                                <div className="header-elements">
                                    ...
                                    <div className="main-menu-ex main-menu-ex1">
                                        ...
                                        {mainMenuStyle == "one-page" ? <MainMenuOnePage5 /> : null}
                                    </div>
