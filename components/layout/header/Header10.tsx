...
export default function Header({ scroll, isMobileMenu, handleMobileMenu, mainMenuStyle }: any) {
    return (
        <>
            <header>
                <div className={`header-area header-area10 header-area-all d-none d-lg-block ${scroll ? "sticky" : ""} `} id="header">
                            ...
                            <div className="col-12">
                                <div className="header-elements">
                                    <div className="site-logo">
                                        <Link href="/">
                                            <img src="assets/img/logo/header-logo10.png" alt="" />
                                        </Link>
                                    </div>
                                    ...
                                    <div className="header2-buttons">
                                        <div className="button">
                                            <Link className="theme-btn16" href="/contact">
                                                Contact Us&nbsp;
                                                <span>
