                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="mission-box">
                                <div className="icon">
                                    <img src="/assets/img/icons/mission-icon1.png" alt="CodM Software mission icon" decoding="async" loading="lazy" />
                                </div>
                                <div className="heading1">
                                    <h5>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="mission-box">
                                <div className="icon">
                                    <img src="/assets/img/icons/mission-icon2.png" alt="CodM Software vision icon" decoding="async" loading="lazy" />
                                </div>
                                <div className="heading1">
                                    <h5>
