                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        <div className="image overlay-anim">
                                            <img src="/assets/img/about/about3-img1.png" alt="CodM Software Salesforce consulting team collaboration" decoding="async" loading="lazy" />
                                        </div>
                                    ...
                                    <div className="col-lg-6">
                                        ...
                                        <div className="image overlay-anim">
                                            <img src="/assets/img/about/about3-img2.png" alt="CodM Software CRM implementation experts at work" decoding="async" loading="lazy" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-6">
                            <div className="heading1 about3-heading">
                                ...
                                <div className="about3-icon-box">
                                    <div className="">
                                        <div className="icon">
                                            <img src="/assets/img/icons/about3-icon1.png" alt="Salesforce consulting expertise icon" decoding="async" loading="lazy" />
                                        </div>
                                    </div>
                                ...
                                <div className="about3-icon-box">
                                    <div className="">
                                        <div className="icon">
                                            <img src="/assets/img/icons/about3-icon2.png" alt="Business growth and CRM success icon" decoding="async" loading="lazy" />
                                        </div>
                                    </div>
                                    <div className="heading1">
                                        <h5>
