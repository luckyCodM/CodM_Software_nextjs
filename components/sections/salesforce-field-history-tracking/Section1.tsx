                            ...
                            <div className="service-details-area left-padding">
                                <article>
                                    <div className="heading1">
                                        <div className="image">
                                            <img src="/assets/img/service/Field History Tracking.png" alt="Salesforce Field History Tracking solution" decoding="async" loading="lazy" />
                                        </div>
                                ...
                                <article>
                                    <div className="row align-items-center">
                                        <div className="col-lg-6">
                                            <div className="space30" />
                                            <div className="image">
                                                <img src="/assets/img/project/FHT.png" alt="Salesforce Field History Tracking product screenshot" decoding="async" loading="lazy" />
                                            </div>
                                        </div>
                                        <div className="col-lg-6">
                                            <div className="space16" />
