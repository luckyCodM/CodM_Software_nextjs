                        ...
                        <div className="row">
                            <div className="col-lg-8 m-auto text-center">
                                <div className="heading1">
                                    ...
                                    <h2 className="text-anime-style-3">Our Salesforce Capabilities</h2>
                                            ...
                                            <div className="project-two__box-content">
                                                ...
                                                <div className="project-two__box-content-inner">
                                                    <div className="project-two__box-content-inner-wrapper">
                                                        <p>Service</p>
                                                        <h4>
                                                            <Link href="/project-details">1. Salesforce Implementation</Link>
                                                        </h4>
                                                    </div>
                                                    <div className="icon">
                                            ...
                                            <div className="project-two__box-content">
                                                ...
                                                <div className="project-two__box-content-inner">
                                                    <div className="project-two__box-content-inner-wrapper">
                                                        <p>Service</p>
                                                        <h4>
                                                            <Link href="/project-details">2. Custom Development</Link>
                                                        </h4>
                                                    </div>
                                                    <div className="icon">
                                                        <Link href="/project-details">
                                            ...
                                            <div className="project-two__box-content">
                                                ...
                                                <div className="project-two__box-content-inner">
                                                    <div className="project-two__box-content-inner-wrapper">
                                                        <p>Service</p>
                                                        <h4>
                                                            <Link href="/project-details">3. Integration Services</Link>
                                                        </h4>
                                                    </div>
                                                    <div className="icon">
                                                        <Link href="/project-details">
                                            ...
                                            <div className="project-two__box-content">
                                                ...
                                                <div className="project-two__box-content-inner">
                                                    <div className="project-two__box-content-inner-wrapper">
                                                        <p>Service</p>
                                                        <h4>
                                                            <Link href="/project-details">4. Salesforce Consulting</Link>
                                                        </h4>
                                                    </div>
                                                    <div className="icon">
                                                        <Link href="/project-details">
                                            ...
                                            <div className="project-two__box-content">
                                                ...
                                                <div className="project-two__box-content-inner">
                                                    <div className="project-two__box-content-inner-wrapper">
                                                        <p>Service</p>
                                                        <h4>
                                                            <Link href="/project-details">5. Support & Maintenance</Link>
                                                        </h4>
                                                    </div>
                                                    <div className="icon">
                                                        <Link href="/project-details">
                                            ...
                                            <div className="project-two__box-content">
                                                ...
                                                <div className="project-two__box-content-inner">
                                                    <div className="project-two__box-content-inner-wrapper">
                                                        <p>Service</p>
                                                        <h4>
                                                            <Link href="/project-details">6. Training & Adoption</Link>
                                                        </h4>
                                                    </div>
                                                    <div className="icon">
                                                        <Link href="/project-details">
                                            ...
                                            <div className="project-two__box-content">
                                                ...
                                                <div className="project-two__box-content-inner">
                                                    <div className="project-two__box-content-inner-wrapper">
                                                        <p>Service</p>
                                                        <h4>
                                                            <Link href="/project-details"> QA Services</Link>
                                                        </h4>
                                                    </div>
                                                    <div className="icon">
                                                        <Link href="/project-details">
                                            ...
                                            <div className="project-two__box-content">
                                                ...
                                                <div className="project-two__box-content-inner">
                                                    <div className="project-two__box-content-inner-wrapper">
                                                        <p>Service</p>
                                                        <h4>
                                                            <Link href="/project-details">Salesforce Customer 360</Link>
                                                        </h4>
                                                    </div>
                                                    <div className="icon">
                                                        <Link href="/project-details">
                                            ...
                                            <div className="project-two__box-content">
                                                ...
                                                <div className="project-two__box-content-inner">
                                                    <div className="project-two__box-content-inner-wrapper">
                                                        <p>Service</p>
                                                        <h4>
                                                            <Link href="/project-details">Salesforce AI services</Link>
                                                        </h4>
                                                    </div>
                                                    <div className="icon">
                                                        <Link href="/project-details">
