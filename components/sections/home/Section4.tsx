                    ...
                    <div className="row">
                        <div className="col-lg-4" data-aos="zoom-in-up" data-aos-duration={1200}>
                            <div className="service-box">
                                <div className="icon">
                                    <img src="/assets/img/icons/service8-icon1.svg" alt="Financial Services Cloud icon" decoding="async" loading="lazy" />
                                </div>
                        ...
                        <div className="col-lg-4" data-aos="zoom-in-up" data-aos-duration={1000}>
                            <div className="service-box">
                                <div className="icon">
                                    <img src="/assets/img/icons/service8-icon2.svg" alt="Agentforce and AI icon" decoding="async" loading="lazy" />
                                </div>
                                <div className="heading">
                                    <h4>
                        ...
                        <div className="col-lg-4" data-aos="zoom-in-up" data-aos-duration={700}>
                            <div className="service-box">
                                <div className="icon">
                                    <img src="/assets/img/icons/service8-icon6.svg" alt="Banking services icon" decoding="async" loading="lazy" />
                                </div>
                                <div className="heading">
                                    <h4>
