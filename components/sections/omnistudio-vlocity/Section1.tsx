                            ...
                            <div className="blog-details-all left-padding">
                                <article>
                                    <div className="blog-details-box">
                                        <div className="image">
                                            {/* <img src="/assets/img/blog/blog-details-img1.png" alt="Salesforce blog detail illustration" decoding="async" loading="lazy" /> */}
                                        </div>
                                        <ul className="users">
                                            <li>
                                            ...
                                            <li>
                                                <img src="/assets/img/icons/blog-details-icon2.png" alt="Article category icon" decoding="async" loading="lazy" /> <Link href="#"> Omnistudio (Vlocity)</Link>
                                            </li>
                                            <li>
                                ...
                                <article>
                                    <div className="blog-details-box">
                                        <div className="image">
                                            <img src="/assets/img/blog/Omni-blog1.png" alt="Salesforce OmniStudio Vlocity guide image" decoding="async" loading="lazy" />
                                        </div>
